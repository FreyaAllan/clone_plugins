...
async def pm_text(bot, message):
    ...
    if total_results == 0:
        return 
    btn = [[
             InlineKeyboardButton("❤️ JOIN GROUP ❤️", url="https://telegram.me/jenna_group")
             ],[
             InlineKeyboardButton('🌄 CHANGE PHOTO 🌄', callback_data='change_photo')
        ]]
    await message.reply_photo(photo=random.choice(PICS), caption=f"<b>hello 👋 {message.from_user.mention}, {str(total_results)} RESULTS  are found {search}. Kindly search again in @r_from_rgi_support</b>",
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn = [[
                ...
                InlineKeyboardButton("CHACK SPELLING", callback_data=f"chack_spelling#{from_user}")
             ],[
                InlineKeyboardButton("REJECT", callback_data=f"reject_movie#{from_user}"),
                InlineKeyboardButton("MANY REQUEST", callback_data=f"many_request#{from_user}"),
              ]]
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.message.edit_text(f"<b><strike>{content}</strike> 😞 unavailable</b>")
            await query.answer("Sᴇᴛ ᴛᴏ Uɴᴀᴠᴀɪʟᴀʙʟᴇ !")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ sᴜғғɪᴄɪᴀɴᴛ ʀɪɢʜᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)
        ...
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            content = query.message.text
            await query.message.edit_text(f"<b><strike>{content}</strike> uploaded ✅</b>")
            await query.answer("Sᴇᴛ ᴛᴏ Uᴘʟᴏᴀᴅᴇᴅ !")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ʜᴀs ʙᴇᴇɴ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
        ...
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            content = query.message.text
            await query.message.edit_text(f"<b><strike>{content}</strike> 😭 already available</b>")
            await query.answer("Sᴇᴛ ᴛᴏ Aʟʀᴇᴀᴅʏ Aᴠᴀɪʟᴀʙʟᴇ !")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Yᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ ᴏɴ ᴏᴜʀ ʙᴏᴛ's ᴅᴀᴛᴀʙᴀsᴇ. Kɪɴᴅʟʏ sᴇᴀʀᴄʜ ɪɴ ᴏᴜʀ Gʀᴏᴜᴘ.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ sᴜғғɪᴄɪᴀɴᴛ ʀɪɢᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)

    elif query.data.startswith("chack_spelling"):
        ident, from_user = query.data.split("#")
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            content = query.message.text
            await query.message.edit_text(f"<b><strike>{content}</strike> 😞 CHECK SPELLING</b>")
            await query.answer("Sᴇᴛ ᴛᴏ chack spelling!")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ because of incorrect spelling. Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ. Just go to Google.com & check right spelling</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ because of incorrect spelling . Sᴏ ᴏᴜʀ ᴍᴏᴅᴇʀᴀᴛᴏʀs ᴄᴀɴ'ᴛ ᴜᴘʟᴏᴀᴅ ɪᴛ just go to Google.com & check your spelling.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ sᴜғғɪᴄɪᴀɴᴛ ʀɪɢʜᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)

    elif query.data.startswith("reject_movie"):
        ident, from_user = query.data.split("#")
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            content = query.message.text
            await query.message.edit_text(f"<b><strike>{content}</strike> ❌ REJECTED</b>")
            await query.answer("Sᴇᴛ ᴛᴏ REJECTED!")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs REJECTED ❌. Because of our policy if you think it's an error just contact @Freya_Allan_admin_bot</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs REJECTED ❌. Because of our policy if you think it's an error just contact @Freya_Allan_admin_bot.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ sᴜғғɪᴄɪᴀɴᴛ ʀɪɢʜᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)

    elif query.data.startswith("many_request"):
        ident, from_user = query.data.split("#")
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            content = query.message.text
            await query.message.edit_text(f"<b><strike>{content}</strike> ❌ 🤬 MANY REQUESTS</b>")
            await query.answer("Sᴇᴛ ᴛᴏ 🤬 MANY REQUESTS!")
            try:
                await client.send_photo(chat_id=int(from_user), photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs REJECTED ❌. BECAUSE OF 🤬 YOU ARE REQUESTED MANY TIMES SO STOP IT OTHERWISE YOU WILL GET BAN TO USE ME</b>")
            except UserIsBlocked:
                await client.reply_photo(photo=random.choice(PICS), caption=f"<b>Hᴇʏ {user.mention}, Sᴏʀʀʏ Yᴏᴜʀ ʀᴇᴏ‌ᴜᴇsᴛ ɪs REJECTED ❌.  BECAUSE OF 🤬 YOU ARE REQUESTED MANY TIMES SO STOP IT OTHERWISE YOU WILL GET BAN TO USE ME.\n\nNᴏᴛᴇ: Tʜɪs ᴍᴇssᴀɢᴇ ɪs sᴇɴᴛ ᴛᴏ ᴛʜɪs ɢʀᴏᴜᴘ ʙᴇᴄᴀᴜsᴇ ʏᴏᴜ'ᴠᴇ ʙʟᴏᴄᴋᴇᴅ ᴛʜᴇ ʙᴏᴛ. Tᴏ sᴇɴᴅ ᴛʜɪs ᴍᴇssᴀɢᴇ ᴛᴏ ʏᴏᴜʀ PM, Mᴜsᴛ ᴜɴʙʟᴏᴄᴋ ᴛʜᴇ ʙᴏᴛ.</b>")
        else:
            await query.answer("Yᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ sᴜғғɪᴄɪᴀɴᴛ ʀɪɢʜᴛs ᴛᴏ ᴅᴏ ᴛʜɪs !", show_alert=True)
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=f"<b>hello 👋 {query.from_user.mention}, Kindly search again in @r_from_rgi_support</b>",
            disable_web_page_preview=True, 
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        free = get_size(free)
        await query.message.edit_text(
            text=STATUS_TXT.format(total, users, chats, monsize, free),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    ...
    elif query.data == "jenna_checksub":
        ...
        if ACHANNEL and not await is_refsubs(client, query):
            await query.answer(script.ACHANNEL, show_alert=True)
            return
        ...
        try:
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Freya_Allan_admin_bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
